...
function Celebrate({ before, after, jobTitle, tieredUp, newlyUnlocked, newBadges, onGo }: {
  ...
  return (
    <>
      {tieredUp ? (
        <div className="text-center rounded-[18px] p-4 mb-3.5 text-on-feature animate-pop relative overflow-hidden feature-band">
      ...
      <Card className="p-3.5 flex gap-3.5 items-center mb-3.5">
        <div className="relative shrink-0">
          <Ring pct={rep} size={60} stroke={7}><b className="text-lead font-extrabold text-ink font-mono tnum">{shownRep}</b></Ring>
